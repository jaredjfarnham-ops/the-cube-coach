...
const PUZZLES = [
  { id:'3x3', name:'3×3  (Rubik’s Cube)', art:'cube3', methods:[
      ...
      { id:'zz', name:'ZZ', blurb:'Orient all edges first for rotationless solves.',
        items:[ {id:'eoline',name:'EOLine'}, {id:'zzf2l',name:'ZZ-F2L'}, {id:'ocll',name:'OCLL + PLL'},
          {id:'zbll-solved',name:'ZBLL — Solved Corners'}, {id:'zbll-adj-a',name:'ZBLL — Adjacent Swap A'}, {id:'zbll-adj-b',name:'ZBLL — Adjacent Swap B'}, {id:'zbll-diag',name:'ZBLL — Diagonal Swap'}, {id:'zbll-cyc-a',name:'ZBLL — Corner 3-Cycle A'}, {id:'zbll-cyc-b',name:'ZBLL — Corner 3-Cycle B'} ]},
