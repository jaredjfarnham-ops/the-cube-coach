...
(function () {
  ...
  LESSONS['clock/7simul/concept'] = { type:'text', title:'Clock — 7-Simul: How It Works',
    intro:[
      ...
      'The complete solve is nine of those moves — the same nine the scramble uses: <b>UR DR DL UL U R D L ALL</b> — each turned by an amount you work out from the numbers you read. <b>7-Simul’s edge</b> is that you compute <b>every amount during the 15-second inspection</b>, then (reading the back dials through the puzzle) execute the whole thing in one non-stop, flip-free burst — skilled solvers merge the nine into as few as <b>seven</b> turns.'
    ]};
