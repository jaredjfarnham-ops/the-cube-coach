...
(function () {
  ...
  /* ---- Non-WCA puzzles: official random-state scrambles (cubing.js) + a timer. No on-screen model yet. ---- */
  LESSONS['fto/intro/about'] = { type:'text', title:'FTO — Face-Turning Octahedron', intro:[
    'The <b>Face-Turning Octahedron</b> is an octahedron (8 triangular faces) where each <b>face</b> rotates the ring of pieces around it. It has face centres, edges and corners, and is a popular deep-cut shape-mod outside the WCA.',
    'Scrambles here are <b>official random-state</b> (generated by the same engine the WCA tools use) and written in FTO face notation — capital letters for the faces, a <b>′</b> for a counter-clockwise turn. Read the scramble and apply it on your own puzzle.',
    'There is <b>no on-screen model</b> for the FTO yet — this page gives you proper scrambles and a timer; use the <b>FTO Timer</b> to record solves with Ao5 / Ao12.'
  ]};
  LESSONS['fto/timer/solve'] = { type:'trainer', solveOnly:true, puzzle:'fto', title:'FTO Timer',
    intro:['A full-solve timer with <b>official FTO scrambles</b>. Apply the scramble to your own puzzle, hold <b>Space</b> and release to start, then press a key to stop. Times save with Ao5 / Ao12. (No on-screen model yet — follow the scramble notation.)'] };

  LESSONS['mpyra/intro/about'] = { type:'text', title:'Master Pyraminx — Overview', intro:[
    'The <b>Master Pyraminx</b> is a 4-layer Pyraminx — one more layer than the standard puzzle. Alongside the usual tip and face turns it adds <b>inner-slice</b> turns, so there are extra small edge and centre pieces to place.',
    'Scrambles here are <b>official random-state</b> and use Pyraminx-style notation: capital <b>U L R B</b> for the faces, lowercase <b>u l r b</b> for the inner/wide turns, and a <b>′</b> for counter-clockwise.',
    'There is <b>no on-screen model</b> yet — use the <b>Master Pyraminx Timer</b> to scramble and record solves on your own puzzle.'
  ]};
  LESSONS['mpyra/timer/solve'] = { type:'trainer', solveOnly:true, puzzle:'mpyra', title:'Master Pyraminx Timer',
    intro:['A full-solve timer with <b>official Master Pyraminx scrambles</b>. Apply the scramble to your own puzzle, hold <b>Space</b> and release to start, then press a key to stop. Times save with Ao5 / Ao12. (No on-screen model yet — follow the scramble notation.)'] };

  LESSONS['kilo/intro/about'] = { type:'text', title:'Kilominx — Overview', intro:[
    'The <b>Kilominx</b> is a <b>corners-only Megaminx</b> — the dodecahedral equivalent of the 2×2. It has 12 pentagonal faces and no edge pieces, so a face turn moves only corners.',
    'Scrambles here are <b>official random-state</b> and use Megaminx-family face notation (named faces with <b>′</b> for counter-clockwise, plus whole-puzzle rotations).',
    'There is <b>no on-screen model</b> yet — use the <b>Kilominx Timer</b> to scramble and record solves on your own puzzle.'
  ]};
  LESSONS['kilo/timer/solve'] = { type:'trainer', solveOnly:true, puzzle:'kilo', title:'Kilominx Timer',
    intro:['A full-solve timer with <b>official Kilominx scrambles</b>. Apply the scramble to your own puzzle, hold <b>Space</b> and release to start, then press a key to stop. Times save with Ao5 / Ao12. (No on-screen model yet — follow the scramble notation.)'] };
})();
